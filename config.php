...
require_once(_MODELS_PATH_ . 'game/Bank.php');
require_once(_MODELS_PATH_ . 'game/Battle.php');
require_once(_MODELS_PATH_ . 'game/City.php');
require_once(_MODELS_PATH_ . 'game/Item.php');
require_once(_MODELS_PATH_ . 'game/Market.php');
require_once(_MODELS_PATH_ . 'game/Scenario.php');
require_once(_MODELS_PATH_ . 'game/Vessel.php');
require_once(_MODELS_PATH_ . 'game/Weapon.php');
...
require_once(_CONTROLLERS_PATH_ . 'BankController.php');
require_once(_CONTROLLERS_PATH_ . 'BattleController.php');
require_once(_CONTROLLERS_PATH_ . 'CityController.php');
require_once(_CONTROLLERS_PATH_ . 'InventoryController.php');
require_once(_CONTROLLERS_PATH_ . 'ItemController.php');
require_once(_CONTROLLERS_PATH_ . 'LocaleAppController.php');
require_once(_CONTROLLERS_PATH_ . 'MarketController.php');
